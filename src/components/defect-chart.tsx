    ...
    >
      <PieChart>
        ...
        <ChartLegend
          ...
          className="flex-wrap gap-2 data-[align=center]:justify-center"
        />
      </PieChart>
        <div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[calc(50%_-_25px)] flex flex-col items-center justify-center pointer-events-none" 
          aria-hidden="true">
